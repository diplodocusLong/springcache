...
public class AutoGeneratorHelper{
    public static void main(String[] args) {
       ...
       // tableFillList.add(new TableFill("isOut", FieldFill.INSERT));
        ...
        AutoGenerator mpg = new AutoGenerator().setGlobalConfig(
                // 全局配置
                new GlobalConfig()
                        .setOutputDir("/home/nevermore/LearnSpace/src/main/java")//输出目录
                ...
                new PackageConfig()
                        /*        .setModuleName("test")*/
                        .setParent("com.lianglong.cache")// 自定义包路径
